...
public interface Database {    
    /**   * Creates/drops table or database.   * @param query structure definition query (e.g., create or drop table)   * @returns   true if success, or false otherwise   * @throws SQLException syntax error
     * @param query  
     * @return   
     * @throws java.sql.SQLException */  
    public boolean executeStructureQuery(String query) throws java.sql.SQLException; 
 
 /**   * Select from table   * @param query data retrieval query (e.g., select)  
